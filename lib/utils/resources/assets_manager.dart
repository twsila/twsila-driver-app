...
class ImageAssets {
  ...
  static const String appLogo = "$imagePath/capt_app_log.jpeg";
  ...
  static const String successRegisterSubscriptionBenefits =
      "$imagePath/success_registered_payment.png";
  static const String welcomeToTawselaGraphic =
      "$imagePath/welcome_to_tawsela_graphic.png";
  static const String ratePassengerGraphic = "$imagePath/rate_passenger_gr.png";
  ...
  //main - bottom nav center trip icon (white icon on blue)
  static const String tripCenterIcon = "$imagePath/trip_icon.png";
  ...
  static const String locationPinTripDetailsIc =
      "$imagePath/trip_loc_pin_ic.svg";
  ...
  static const String tripDetailsAsapIcon =
      "$imagePath/asap_trip_details_ic.png";
